...
<head>
    ...
    <link rel="stylesheet" href="${path}/resources/css/mypage/check.css" />
      ...
      <header id="header">
        ...
        <div id="contents">
            ...
            <table>
                ...
                <tr class="table_c">
                    <td>${map.res.accom_name}</td>                
                    <td>${map.res.resev_st}</td>
                    <td>${map.res.resev_end}</td>
                    <td>${map.room.room_name}</td>
                    <td>${map.room.room_num}</td>
                    <td>${map.room.room_price}</td>
                    <td><a href="./delResAction?user_id=${user_id}">예약취소</a></td>
