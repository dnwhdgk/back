      ...
      <div id="wrap">
        ...
        <div id="container">
         ...
         <div id="title"></div>
          ...
          <ul class="list">
            <c:forEach var="getHotel" items="${list}">
            	<li>
            		<p>${getHotel.accom_name }</p>
            		<p>${getHotel.accom_add }</p>
            		<div class="accom_img">
            		<a href="${path }/room?accom_name=${getHotel.accom_name}"><img src="${path}/resources/upload/${getHotel.accom_img}"></a>
            		</div>
            	</li>
            </c:forEach>
