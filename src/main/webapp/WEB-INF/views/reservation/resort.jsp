      ...
      <div id="wrap">
        ...
        <div id="container">
         ...
         <div id="title"></div>
          ...
          <ul class="list">
            <c:forEach var="getResort" items="${list}">
            	<li>
            		<p>${getResort.accom_name }</p>
            		<p>${getResort.accom_add }</p>
            		<div class="accom_img"><a href="${path }/room?accom_name=${getResort.accom_name}"><img src="${path}/resources/upload/${getResort.accom_img}"></a></div>
            	</li>
            </c:forEach>
