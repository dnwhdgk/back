...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="${path}/resources/css/reservation/room.css" />
      ...
      <div id="wrap">
        ...
        <div id="contents">
            <section class="group">
                ...
                <article class="hotel_img">
                    <img src="${path}/resources/upload/${map.accom.accom_img}" alt="">
                </article>
				...
				<h2>${map.accom.accom_name}</h2>
                        ...
                        <ul>
                            <li>>${map.accom.accom_add}</li>
                        </ul>
                    </div>
                    
                    <div class="explain">
                        <h3>사장님의 한마디</h3>
                        <p>>${map.accom.accom_text}</p>
                    </div>
                </article>
            </section>
            ...
            <section class="reserve">
                <ul class="aaa">
                	<c:forEach var="room" items="${map.roomList}">
	                    <li>
	                        <img src="${path}/resources/upload/${room.room_img}" alt="">
	                        <p>${room.room_name }</p>
	                        <p>${room.room_num }</p>
	                        <p>${room.room_price }</p>
	                       	 <a href="${path}/res?room_id=${room.room_id}&accom_name=${room.accom_name}">예약하기</a>
	                    </li>
                 	</c:forEach>
                </ul>
